...
{
    class TreeManagerAccessor : TreeManager
    {
        new public Changes CreateNewUser(string name, PwGroup useAsHome = null)
        {
            return base.CreateNewUser(name);
        }

        new public void DeleteUser(PwEntry user)
        {
